...
namespace OpenIdentityCustomService.AppClient
{
    public class AppClients
    {
        ...
        public static List<Client> Current()
        {
            return new List<Client>()
            { new Client
                {
                    ClientName = "Cash Rewards",//"Resource Owner Flow Client",
                    ClientId = "cashrewards.rofc",
                ...
                new Client
                {
                    //ClientName = "OpenID Connect without Client Library Sample",
                      ClientName = "Cash Rewards Web Client",
                    ClientId = "cashrewards.impc",
                    Flow = Flows.Implicit,
                    ...
                    ClientUri = "https://www.cashrewards.com.au/",
                    ...
                    {
                         "http://openidtest.yoursportspass.com/direct/signInCallback",
                        "http://localhost:55820/direct/signInCallback",
                        "http://172.18.29.125:8040/direct/signInCallback",
                    }
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris = new List<string>
                    {
                       ...
                       "http://localhost:55820/ManualCodeFlowDemo/callback",
                    },
                ...
                {
                    //ClientName = "OpenID Connect without Client Library Sample",
                      ClientName = "Sports Pass Direct Client1",
