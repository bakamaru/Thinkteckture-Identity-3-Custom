    ...
    public class DirectController : Controller
    {
        ...
        public ActionResult SignIn()
        {
            ...
            var url = Constants.AuthorizeEndpoint +
                "?client_id=cashrewards.impc" +
                "&response_type=id_token" +
                "&scope=openid email profile" +
                   //  "&redirect_uri=http://172.18.29.125:8040/direct/signInCallback" +
                   "&redirect_uri=http://openidtest.yoursportspass.com/direct/signInCallback" +
        ...
        private async Task<IEnumerable<Claim>> ValidateIdentityTokenAsync(string token, string state)
        {
            ...
            {
                ValidAudience = "cashrewards.impc",
